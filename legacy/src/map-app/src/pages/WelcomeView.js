...
18.6.2026 Aki Karppinen
Sponsors and image_sources
  ...
  if (props.isMobile) {
    return (
 	...
 	<Box className={styledClasses.iconContainer} style={{flex: 2}}>
         <img src="pallaksen_pollot_logo.png" alt="Pallaksen pöllöt logo" className={styledClasses.icon} />
        </Box>
        ...
        <Box className={styledClasses.sponsorContainer} style={{flex: 2}}>
          { <a href="http://www.google.fi" target="_blank" rel="noopener noreferrer">
            <img src="DISCOVER_MUONIO_LOGO.png" alt="Sponsor logo" className={styledClasses.sponsor} />
          </a> }

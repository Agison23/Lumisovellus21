...
_responseData = rawData == null ? null : deserialize<ApiV1ObservationsGet200Response, ApiV1ObservationsGet200Response>(rawData, 'ApiV1ObservationsGet200Response', growable: true);
  ...
  /// Parameters:
  /// * [id] - Segment ID (UUID)
  /// * [days] - Number of days to look back for this segment
  /// * [limit] - Maximum number of user reviews to include
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1SegmentsIdObservationsGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1SegmentsIdObservationsGet200Response>> apiV1SegmentsIdObservationsGet({ 
    required String id,
    String? days,
    String? limit,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/segments/{id}/observations'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiV1SegmentsIdObservationsGet200Response? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ApiV1SegmentsIdObservationsGet200Response, ApiV1SegmentsIdObservationsGet200Response>(rawData, 'ApiV1SegmentsIdObservationsGet200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiV1SegmentsIdObservationsGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1SnowTypesIdSecondaryPost200Response>> apiV1SegmentsIdReviewsPost({ 
    required String id,

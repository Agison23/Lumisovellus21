...
class SnowTypesApi {
  ...
  Future<Response<ApiV1SnowTypesGet200Response>> apiV1SnowTypesGet({ 
...
_responseData = rawData == null ? null : deserialize<ApiV1SnowTypesGet200Response, ApiV1SnowTypesGet200Response>(rawData, 'ApiV1SnowTypesGet200Response', growable: true);
  ...
  Future<Response<ApiV1SnowTypesPost201Response>> apiV1SnowTypesIdSecondaryPost({ 
    ...
    final _path = r'/api/v1/snow-types/{id}/secondary'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

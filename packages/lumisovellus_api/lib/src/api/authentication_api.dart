...
class AuthenticationApi {
  ...
  Future<Response<AuthResetPasswordPost200Response>> authChangePasswordPut({ 
...
_responseData = rawData == null ? null : deserialize<AuthResetPasswordPost200Response, AuthResetPasswordPost200Response>(rawData, 'AuthResetPasswordPost200Response', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRegisterPost201Response>> authLoginPost({ 
...
_responseData = rawData == null ? null : deserialize<AuthRegisterPost201Response, AuthRegisterPost201Response>(rawData, 'AuthRegisterPost201Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResetPasswordPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResetPasswordPost200Response>> authLogoutPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<AuthResetPasswordPost200Response, AuthResetPasswordPost200Response>(rawData, 'AuthResetPasswordPost200Response', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProfileGet200Response>> authProfileGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<AuthProfileGet200Response, AuthProfileGet200Response>(rawData, 'AuthProfileGet200Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthProfileGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProfileGet200Response>> authProfilePut({ 
...
_responseData = rawData == null ? null : deserialize<AuthRefreshTokenPost200Response, AuthRefreshTokenPost200Response>(rawData, 'AuthRefreshTokenPost200Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthRegisterPost201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRegisterPost201Response>> authRegisterPost({ 
...
_responseData = rawData == null ? null : deserialize<AuthRegisterPost201Response, AuthRegisterPost201Response>(rawData, 'AuthRegisterPost201Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResetPasswordPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResetPasswordPost200Response>> authResetPasswordPost({ 
...
_responseData = rawData == null ? null : deserialize<AuthResetPasswordPost200Response, AuthResetPasswordPost200Response>(rawData, 'AuthResetPasswordPost200Response', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthVerifyTokenGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthVerifyTokenGet200Response>> authVerifyTokenGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/verify-token';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AuthVerifyTokenGet200Response? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<AuthVerifyTokenGet200Response, AuthVerifyTokenGet200Response>(rawData, 'AuthVerifyTokenGet200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<AuthVerifyTokenGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
class _StepSpecifyType extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedDesc = selected.isEmpty
        ? ''
        : selected.first.explanation ?? '';
    final hazardButtons = hazards;

    String labelForHazard(String value) {
      ...
      children: [
          ...
          children: [
            for (final st in options)
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  fixedSize: const Size(100, 50),
                  backgroundColor: selectedSnowTypeId == st.id
                      ? Colors.black
                      : Colors.white,
                  foregroundColor: selectedSnowTypeId == st.id
                      ? Colors.white
                      : Colors.black,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10),
        ...
        Row(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed:
                  (selectedSnowTypeId != null || selectedHazards.isNotEmpty)
                  ? onSubmit
                  : null,
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.black,

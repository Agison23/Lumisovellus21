...
final DateTime updatedSince = 2024-01-01T00:00:00Z; // DateTime | Return updates since this timestamp (ISO 8601)
final DateTime from = 2024-01-01T00:00:00Z; // DateTime | Start of time range (ISO 8601). If provided, overrides days/updatedSince.

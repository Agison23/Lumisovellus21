...
async function main() {
  ...
  const snowTypes = [
    { name: 'Uusi lumi', colour: '#FFFFFF', skiability: 5, categoryId: 1, explanation: 'Tuore, pehmeä lumi' },
    { name: 'Kova lumi', colour: '#E0E0E0', skiability: 3, categoryId: 1, explanation: 'Kovettunutta lunta' },
    { name: 'Jäinen lumi', colour: '#B0C4DE', skiability: 2, categoryId: 1, explanation: 'Jäätynyttä lunta' },
    { name: 'Märkä lumi', colour: '#87CEEB', skiability: 1, categoryId: 1, explanation: 'Märkää, raskasta lunta' },
    { name: 'Harsi', colour: '#F0F8FF', skiability: 4, categoryId: 2, explanation: 'Pinta harsia' },
    { name: 'Kuura', colour: '#F5F5F5', skiability: 3, categoryId: 2, explanation: 'Kuurakerros' },
  ];
  ...
  for (let i = 0; i < 10; i++) {
    const randomSegment = segments_list[Math.floor(Math.random() * segments_list.length)];

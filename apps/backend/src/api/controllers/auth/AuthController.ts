...
export class AuthController {
  static async register(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (error instanceof z.ZodError) {
        ApiResponseHandler.validationError(res, 'Validation failed', error.errors);
        return;
      }
  ...
  static async logout(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      ApiResponseHandler.success(res, { message: 'Logged out successfully' }, 200);
    } catch (error) {
  ...
  static async changePassword(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      ApiResponseHandler.success(res, { message: 'Password changed successfully' }, 200);
    } catch (error) {
      if (error instanceof z.ZodError) {
        ApiResponseHandler.validationError(res, 'Validation failed', error.errors);
        return;

...
import { LocationUpdateRequest, BatteryUpdateRequest, RoleUpdateRequest, UserRole } from '../../types';

export class UsersService extends BaseService {
  async updateLocation(deviceId: string, locationData: LocationUpdateRequest, ipAddress: string): Promise<void> {
    try {
  ...
  async updateBattery(deviceId: string, batteryData: BatteryUpdateRequest): Promise<void> {
    try {
  ...
  async updateRole(deviceId: string, roleData: RoleUpdateRequest): Promise<UserRole> {
    try {

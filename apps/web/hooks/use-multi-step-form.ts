...
export interface SnowConditionFormData {
	...
	// Step 2 (Specify): Snow type details
	snowTypeDetails: number | null; // Could be skiability level or other detail
	obstacleIds: string[] | null; // Optional array of obstacle IDs
